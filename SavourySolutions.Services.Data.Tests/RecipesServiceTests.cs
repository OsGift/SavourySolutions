    ...
    public class RecipesServiceTests : IAsyncDisposable, IClassFixture<Configuration>
    {
        ...
        public async Task TestAddingRecipeWithInvalidDifficulty()
        {
            ...
            var exception = await Assert
                .ThrowsAsync<ArgumentException>(async () => await this.recipesService.CreateAsync(model, this.ApplicationUser.Id));
        ...
        public async Task TestAddingRecipeWithMissingCategory()
        {
            ...
            var exception = await Assert
                .ThrowsAsync<NullReferenceException>(async () => await this.recipesService.CreateAsync(model, this.ApplicationUser.Id));
        ...
        public async Task TestIfGetAllRecipesByUserIdWorks()
        {
            ...
            var model = await this.recipesService
                .GetAllRecipesByUserId<RecipeDetailsViewModel>(this.ApplicationUser.Id);
