    ...
    public class ArticlesServiceTests : IAsyncDisposable, IClassFixture<Configuration>
    {
        ...
        public async Task TestAddingRecipeWithMissingCategory()
        {
            ...
            var exception = await Assert
                .ThrowsAsync<NullReferenceException>(async () => await this.articlesService.CreateAsync(model, this.ApplicationUser.Id));
        ...
        public async Task TestAddingAlreadyExistingArticle()
        {
            ...
            var exception = await Assert
                .ThrowsAsync<ArgumentException>(async () => await this.articlesService.CreateAsync(model, this.ApplicationUser.Id));
        ...
        public async Task TestEditingArticleWithMissingArticle()
        {
            ...
            var exception = await Assert
                .ThrowsAsync<NullReferenceException>(async () => await this.articlesService.EditAsync(model, this.ApplicationUser.Id));
