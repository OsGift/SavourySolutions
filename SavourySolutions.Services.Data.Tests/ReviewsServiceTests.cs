namespace SavourySolutions.Services.Data.Tests
{
    ...
    public class ReviewsServiceTests : IAsyncDisposable
    {
        ...
        private ApplicationUser secondApplicationUser;
        ...
        public async Task CheckIfGetReviewByIdWorksCorrectly()
        {
            ...
            var expectedModel = new ReviewListingViewModel
            {
                ...
                UserUsername = this.firstApplicationUser.UserName,
            };
        ...
        [Fact]
        public async Task CheckIfCreateAsyncDoesNotCreateDuplicate()
        {
            this.SeedDatabase();
        ...
        private void InitializeFields()
        {
            ...
            this.secondApplicationUser = new ApplicationUser
            {
                Id = "2",
                FullName = "Incho",
        ...
        {
            await this.usersRepository.AddAsync(this.firstApplicationUser);
            await this.usersRepository.AddAsync(this.secondApplicationUser);
